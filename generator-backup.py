...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', dest="peers", default=5, type=int, help='Number of Peers per Organization ')
    ...
    parser.add_argument('-c', dest="consortium", default="WebConsortium", type=str,help='The Consortium that will be used')
