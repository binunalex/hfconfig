...
A Hyperledger Fabric instance generated by the system is represented by a docker-compose file. To deploy it on a cloud, we use the Move2Kube tool that generates a cloud deployment from a docker compose.

<h2> Necessary installations: </h2>

Install [Move2Kube](https://move2kube.konveyor.io). <br>
