...
A Hyperledger Fabric instance generated by the system is represented by a docker-compose file. To deploy it on a cloud, we use [Move2Kube](https://move2kube.konveyor.io) that generates a cloud deployment from a docker compose. 
